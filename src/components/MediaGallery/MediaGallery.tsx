        ...
        {(!Array.isArray(resources) || resources.length === 0) && (
          <div className="w-full text-center py-20">
            <div className="max-w-md mx-auto">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">Your gallery is empty</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-8">Start building your photo collection by uploading your first image</p>
              {process.env.NEXT_PUBLIC_PHOTOCRATE_MODE !== 'read-only' && (
                <UploadButton>
